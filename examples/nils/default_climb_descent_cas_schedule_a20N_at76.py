...
df_at76_climb = read_ptf_results(os.path.join(directory, "V_316_AT76_CLIMB_20251004_133316.PTF"))
df_a20n_descent = read_ptf_results(os.path.join(directory, "V_316_A20N_DESCENT_20251004_133315.PTF"))
df_at76_descent = read_ptf_results(os.path.join(directory, "V_316_AT76_DESCENT_20251004_133316.PTF"))
...
crossoverAltitude_descent_at76 = conv.m2ft(atm.crossOver(Vdes2_at76, Mdes_at76))
crossoverAltitude_descent_a20n = conv.m2ft(atm.crossOver(Vdes2_a20n, Mdes_a20n))
...
jet_climb_schedule_altitudes = [1499, 2999, 3999, 4999, 5999, 9999, crossoverAltitude_climb_a20n]
tp_climb_schedule_altitudes = [499, 999, 1499, 9999, crossoverAltitude_climb_at76]
descent_schedule_altitudes = [999, 1499, 1999, 2999, 5999, 9999, crossoverAltitude_descent_a20n, crossoverAltitude_descent_at76]

fig, ax = plt.subplots()

# ax.plot(df_a20n_climb['CAS'][:10], df_a20n_climb['Hp'][:10], color='blue', linestyle='solid', label='A20N climb', marker='.')
ax.plot(df_a20n_climb['TAS'], df_a20n_climb['Hp'], color='blue', linestyle='solid', label='A20N climb', marker='.')
ax.plot(df_at76_climb['TAS'], df_at76_climb['Hp'], color='red', linestyle='solid', label='AT76 climb', marker='.')

# ax.plot(df_a20n_descent['CAS'], df_a20n_descent['Hp'], color='blue', linestyle='dashed', label='A20N descent', marker='.')
ax.plot(df_a20n_descent['TAS'], df_a20n_descent['Hp'], color='blue', linestyle='dashed', label='A20N descent', marker='.')
ax.plot(df_at76_descent['TAS'], df_at76_descent['Hp'], color='red', linestyle='dashed', label='AT76 descent', marker='.')

ax.set_xscale('log')
ax.set_yscale('log')

for h in jet_climb_schedule_altitudes:
    ax.axhline(h, color='blue', linestyle='dotted', lw=1, alpha=0.5, label=f'A20N climb {h}')

for h in tp_climb_schedule_altitudes:
    ax.axhline(h, color='red', linestyle='dotted', lw=1, alpha=0.5, label=f'AT76 climb {h}')
    
for h in descent_schedule_altitudes:
    ax.axhline(h, color='black', linestyle='dotted', lw=1, alpha=0.5, label=f'Descent {h}')

ax.axvline(Vcl1_a20n, color='blue', linestyle='dashdot', lw=1, alpha=0.5, label='Vcl1_a20n')
ax.axvline(Vcl2_a20n, color='blue', linestyle='dashdot', lw=1, alpha=0.5, label='Vcl2_a20n')
ax.axvline(Vdes1_a20n, color='blue', linestyle='dashdot', lw=1, alpha=0.5, label='Vdes1_a20n')
ax.axvline(Vdes2_a20n, color='blue', linestyle='dashdot', lw=1, alpha=0.5, label='Vdes2_a20n')

ax.axvline(Vcl1_at76, color='red', linestyle='dashdot', lw=1, alpha=0.5, label='Vcl1_at76')
ax.axvline(Vcl2_at76, color='red', linestyle='dashdot', lw=1, alpha=0.5, label='Vcl2_at76')
ax.axvline(Vdes1_at76, color='red', linestyle='dashdot', lw=1, alpha=0.5, label='Vdes1_at76')
ax.axvline(Vdes2_at76, color='red', linestyle='dashdot', lw=1, alpha=0.5, label='Vdes2_at76')
